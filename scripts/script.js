...
const task_client = document.getElementById('task_client');
...
populatePage = () => {
  debugger
  for ( entrie of timeData.time_entries ) {
    var node = document.createElement("p");
    var textnode = document.createTextNode( entrie.project.name+ ' ' + entrie.client.name + ' ' + entrie.task.name );
    node.appendChild(textnode);
    task_client.appendChild(node);    
  }
